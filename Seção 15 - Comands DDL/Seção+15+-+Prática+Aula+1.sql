...
--n„o pode ter objetos com o mesmo nome no mesmo esquema de usu·rio
SELECT *
FROM   user_objects -- objetos do esquema HR
...
(project_id    NUMBER(6)    NOT NULL,
 ...
 BUDGET        NUMBER(11,2) NOT NULL,--budget orÁamento
...
-- TRUNCATE TABLE, deleta todas as linhas da tabela e libera espaÁo
...
-- DROP TABLE, remove a tabela e coloca numa lixeira chamada recycli bin
