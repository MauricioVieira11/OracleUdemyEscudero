...
CREATE TABLE projects
(project_id    NUMBER(6)    NOT NULL
 CONSTRAINT projects_project_id_pk PRIMARY KEY,--sintaxe a n�vel de coluna
 project_code  VARCHAR2(10) NOT NULL,
 project_name  VARCHAR2(100)NOT NULL,
 department_id NUMBER(4)    NOT NULL,
 CREATION_DATE DATE DEFAULT sysdate NOT NULL,
...
(project_id    NUMBER(6)    NOT NULL, 
 ...
 BUDGET        NUMBER(11,2) NOT NULL,
 DESCRIPTION   VARCHAR2(400)NOT NULL,
 CONSTRAINT projects_project_id_pk PRIMARY KEY(project_id)); --sintaxe a n�vel de tabela
 
 -- Definindo Constraint UNIQUE a nível de Coluna
-- define que a combina��o de valores que comp�e s�o �nicas
DROP TABLE projects;
CREATE TABLE projects
(project_id    NUMBER(6)    NOT NULL
...
--rela��o da tabela com outra tabela. n� � criado �ndice automaticamente. tem que criar manualmente
DROP TABLE projects;
CREATE TABLE projects
(project_id    NUMBER(6)    NOT NULL
 CONSTRAINT projects_project_id_pk PRIMARY KEY,
...
--pode referenciar prmary key ou uma coluna �nica
DROP TABLE projects;
CREATE TABLE projects
(project_id    NUMBER(6)    NOT NULL, 
 project_code  VARCHAR2(10) NOT NULL,
...
(project_id    NUMBER(6)  NOT NULL,
 ...
 --deleta todas as tabelas em cascata, sem perguntar nada
DROP TABLE TEAMS;
CREATE TABLE TEAMS
(project_id    NUMBER(6)  NOT NULL,
 employee_id   NUMBER(6)  NOT NULL,
...
(project_id    NUMBER(6),
 ...
 -- vai fazer valida��o referenciar colunas da tabela, pode usar operadores de compara��o...
