...
SET SERVEROUTPUT ON
ACCEPT pdepartment_id PROMPT 'Digite o Id do departamento: ' --accept: comando sql plus, define vari·vel e define o prompt. o velo que for digitado ser· colocado na vari·vel accept
DECLARE
