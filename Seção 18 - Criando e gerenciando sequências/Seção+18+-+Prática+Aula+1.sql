...
--maior número empregados
CREATE SEQUENCE employees_seq
START WITH 210 -- começar a partir do registro 210
...
-- Recuperando prÃ³ximo valor da Sequencia
...
-- para voltar ao númeor original da sequence, tem que apagar ela e começar de novo
CREATE SEQUENCE employees_seq
START WITH 210
INCREMENT BY 1
NOMAXVALUE 
...
-- cache de 20 números de memória, ganho de performance
